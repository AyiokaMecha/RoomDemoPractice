...
import com.androidpractice.sqlliteroomcompose.ui.theme.SqlLiteRoomComposeTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            SqlLiteRoomComposeTheme {
...
fun MainScreen(
    ...
    Column(
        ...
        LazyColumn(
            ...
            item {
                TitleRow(head1 = "ID", head2 = "Product", head3
                = "Quantity")
            }
            items(list) { product ->
                ProductRow(id = product.id, name =
                product.productName,
